        ...
        <footer className="rounded-3x text-white relative">
                ...
                <section className="appPromoSection relative z-2 sm:z-9 top-0 right-0 md:right-10 xl:right-0 xl:top-40">
                    <div className="appPromoHero">
                        <div className="appPromoCard flex mt-10">
                            ...
                            <img src='/images/landingPage/mobileF.png' className='h-100 w-108 lg:h-120.5 lg:w-125 xl:h-120.5 xl:w-125 2xl:h-140.5 2xl:w-145 relative z-9 -top-32 lg:-top-55 2xl:-top-73.5 left-8 customMobileImage' alt='Footer Mobiles' />
                        </div>
                        <div className='mt-20 ml-10 sm:ml-15 hidden customMobileFooterImage'>
                            <img src='/images/landingPage/mobileF.png' className='h-60 w-100 md:h-110 md:w-108 ' alt='Footer Mobiles' />
                        </div>

                        <div className='appPromoStores mb-5 lg:mb-0'>
                            <img src='/images/landingPage/googlePlay.png' className='appStoreButton cursor-pointer transition-transform duration-200 hover:scale-105 active:scale-95' alt='Google Play' />
                            <img src='/images/landingPage/appStore.png' className='appStoreButton cursor-pointer transition-transform duration-200 hover:scale-105 active:scale-95' alt='App Store' />
                        </div>
                    </div>
                </section>
            )}
            ...
            <div className={`footerBaseBg pt-6 lg:py-10 flex flex-col sm:flex-row justify-evenly items-center  mt-0 ${restrictedPage.includes(pathname) ? "sm:-mt-40 relative z-8 h-64 lg:h-[23.1rem] sm:items-end" : "h-80 sm:items-center"} px-4 sm:px-0 gap-6 sm:gap-0`}>
                <div className="text-center sm:text-left">
                    <img src='/images/CoshotLogoWhite.png' className='w-40 sm:w-71.5 mx-auto sm:mx-0' />
